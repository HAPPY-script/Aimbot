...
Ray.Name = "Ray"
Ray.Position = UDim2.new(0, 0, 0, 75)
Ray.Size = UDim2.new(0, 30, 0, 30)
Ray.BackgroundColor3 = Color3.new(0.0117647, 0.109804, 0.227451)
Ray.BorderSizePixel = 0
Ray.BorderColor3 = Color3.new(0, 0, 0)
Ray.AnchorPoint = Vector2.new(1, 0)
Ray.Text = "Ray"
Ray.TextColor3 = Color3.new(1, 1, 1)
Ray.TextSize = 14
Ray.FontFace = Font.new("rbxasset://fonts/families/Fondamento.json", Enum.FontWeight.Bold, Enum.FontStyle.Normal)
Ray.TextScaled = true
...
WhiteFrame2.Position = UDim2.new(0, 0, 0, 75)
WhiteFrame2.Size = UDim2.new(0, 30, 0, 30)
...
WhiteFrame2.AnchorPoint = Vector2.new(1, 0)
